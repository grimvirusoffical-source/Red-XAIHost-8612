...
import { Check, Globe, Link2, Loader2, Plus, RefreshCcw, Trash2, X } from "lucide-react";
  ...
  return (
    <>
      <PageHeader
        ...
        title="Domains"
        subtitle="Cloudflare creates the zone and the tunnel, your registrar's official API takes the nameservers. No port forwarding, works behind home internet."
        actions={
          ...
          <CardHeader>
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Add the hostname, then hit Connect — zone, nameservers, tunnel and DNS happen in one
                pass.
              </p>
            </div>
              ...
              <CardBody className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <Select
                    ...
                    onChange={(event) =>
                      update.mutate({ id: domain.id, projectId: event.target.value || null })
                    }
                  >
